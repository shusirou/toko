<div class="row">
	...
	<div class="<?php echo e($col_class); ?>">
		<input type="checkbox" name="is_hutang_piutang" id="is_hutang_piutang"> <?php echo e(Request::segment(1) == 'purchases' ? 'Hutang' : 'Piutang'); ?>
	...
	<div class="<?php echo e($col_class); ?>">
		<div class="form-group">
			...
			<div class="input-group">
				...
				<?php echo Form::text("payment[$row_index][amount]", number_format($payment_line['amount'], 2, session('currency')['decimal_separator'], session('currency')['thousand_separator']), ['class' => 'form-control payment-amount input_number', 'required','readonly', 'id' => "amount_$row_index", 'placeholder' => __('sale.amount')]);; ?>
