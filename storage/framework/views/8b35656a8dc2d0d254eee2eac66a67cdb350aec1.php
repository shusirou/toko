<div class="modal-dialog modal-xl no-print" role="document">
  <div class="modal-content">
    ...
    <h4 class="modal-title" id="modalTitle"> <?php echo app('translator')->getFromJson('lang_v1.sell_return'); ?> (<b><?php echo app('translator')->getFromJson('sale.invoice_no'); ?>:</b> <?php echo e($sell->return_parent->invoice_no); ?>)
    </h4>
</div>
<div class="modal-body">
   <div class="row">
      <div class="col-sm-6 col-xs-6">
        ...
        <strong><?php echo app('translator')->getFromJson('lang_v1.return_date'); ?>:</strong> <?php echo e(\Carbon::createFromTimestamp(strtotime($sell->return_parent->transaction_date))->format(session('business.date_format'))); ?><br>
        <strong><?php echo app('translator')->getFromJson('contact.customer'); ?>:</strong> <?php echo e($sell->contact->name); ?> <br>
        <strong><?php echo app('translator')->getFromJson('purchase.business_location'); ?>:</strong> <?php echo e($sell->location->name); ?>

      </div>
      <div class="col-sm-6 col-xs-6">
        <h4><?php echo app('translator')->getFromJson('lang_v1.sell_details'); ?>:</h4>
        <strong><?php echo app('translator')->getFromJson('sale.invoice_no'); ?>:</strong> <?php echo e($sell->invoice_no); ?> <br>
        <strong><?php echo app('translator')->getFromJson('messages.date'); ?>:</strong> <?php echo e(\Carbon::createFromTimestamp(strtotime($sell->transaction_date))->format(session('business.date_format'))); ?>
...
<div class="modal-footer">
    <a href="#" class="print-invoice btn btn-primary" data-href="<?php echo e(action('SellReturnController@printInvoice', [$sell->return_parent->id])); ?>"><i class="fa fa-print" aria-hidden="true"></i> <?php echo app('translator')->getFromJson("messages.print"); ?></a>
