<div class="modal-dialog" role="document">
  <div class="modal-content">
    ...
    <?php echo Form::open(['url' => action('TransactionPaymentController@store'), 'method' => 'post', 'id' => 'transaction_payment_add_form' ]); ?>
    ...
    <div class="modal-body">
      ...
      <?php if(!empty($transaction->contact)): ?>
        <div class="col-md-4">
          <div class="well">
            ...
            <strong><?php echo app('translator')->getFromJson('business.business'); ?>: </strong><?php echo e($transaction->contact->supplier_business_name); ?>
        ...
        <div class="col-md-4">
          ...
          <?php if(in_array($transaction->type, ['sell', 'sell_return'])): ?>
            <strong><?php echo app('translator')->getFromJson('sale.invoice_no'); ?>: </strong><?php echo e($transaction->invoice_no); ?>

          <?php else: ?>
            <strong><?php echo app('translator')->getFromJson('purchase.ref_no'); ?>: </strong><?php echo e($transaction->ref_no); ?>

          <?php endif; ?>
            <br>
            <strong><?php echo app('translator')->getFromJson('purchase.location'); ?>: </strong><?php echo e($transaction->location->name); ?>

          </div>
        </div>
        <div class="col-md-4">
          <div class="well">
            <strong><?php echo app('translator')->getFromJson('sale.total_amount'); ?>: </strong><span class="display_currency" data-currency_symbol="true"><?php echo e($transaction->final_total); ?></span><br>
      ...
      <div class="row payment_row">
         ...
         <div class="col-md-6">
          <div class="form-group">
            <?php echo Form::label("shipping_charges" ,'Shipping Charges:*'); ?>

            <div class="input-group">
              <span class="input-group-addon">
                <i class="fa fa-money"></i>
              </span>
              <?php echo Form::text("shipping_charges", number_format($shipping_charges, 2, session('currency')['decimal_separator'], session('currency')['thousand_separator']), ['class' => 'form-control input_number','readonly'=>'', 'required', 'placeholder' => 'Amount', 'data-rule-max-value' => $shipping_charges, 'data-msg-max-value' => __('lang_v1.max_amount_to_be_paid_is', ['amount' => $amount_formated])]);; ?>
