...
<section class="content-header">
    <h1><?php echo app('translator')->getFromJson('sale.edit_sale'); ?> <small>(<?php echo app('translator')->getFromJson('sale.invoice_no'); ?>: <span class="text-success">#<?php echo e($transaction->invoice_no); ?>)</span></small></h1>
</section>
<!-- Main content -->
		...
		<div class="col-md-12 col-sm-12">
					...
					<div class="<?php if(!empty($commission_agent)): ?> col-sm-3 <?php else: ?> col-sm-4 <?php endif; ?>">
						<div class="form-group">
							...
							<div class="input-group">
								...
								<?php echo Form::text('transaction_date', $trans_date, ['class' => 'form-control', 'readonly', 'required']);; ?>
			...
			<div class="box box-solid">
				<div class="box-body">
				    ...
				    <div class="col-md-12">
				    	<button type="button" class="btn btn-primary pull-right" id="submit-sell"><?php echo app('translator')->getFromJson('messages.update'); ?></button>
				    </div>
				</div>
			</div><!-- /.box -->
