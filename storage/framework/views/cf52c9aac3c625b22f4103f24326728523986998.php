...
<section class="content no-print">
	...
	<div class="box box-solid">
		<div class="box-header">
        	<h3 class="box-title"><?php echo app('translator')->getFromJson('product.add_product_for_labels'); ?></h3>
       	</div>
		<div class="box-body">
			<div class="row">
	...
	<div class="box box-solid">
		<div class="box-header">
			<h3 class="box-title"><?php echo app('translator')->getFromJson( 'barcode.info_in_labels' ); ?></h3>
        </div>
