...
<div class="container">
    <div class="row">
        <h3 class="text-center"><?php echo e(config('app.name', 'POS')); ?> Installation <small>Step 3 of 3</small></h3>
          ...
          <div class="box box-primary active">
            ...
            <div class="box-body">
              ...
              <form class="form" id="details_form" method="post" 
                  ...
                  <div class="col-md-12">
                    <a href="<?php echo e(route('install.checkServer')); ?>" class="btn btn-default pull-left back_button" tabindex="-1">Back</a>
