<div class="modal-header">
    ...
    <h4 class="modal-title" id="modalTitle"> <?php echo app('translator')->getFromJson('purchase.purchase_details'); ?> (<b><?php echo app('translator')->getFromJson('purchase.ref_no'); ?>:</b> #<?php echo e($purchase->ref_no); ?>)
    </h4>
</div>
<div class="modal-body">
  ...
  <div class="row invoice-info">
    <div class="col-sm-4 invoice-col">
      ...
      <?php if($purchase->document): ?>
        <?php
          $document_name = !empty(explode("_", $purchase->document, 2)[1]) ? explode("_", $purchase->document, 2)[1] : $purchase->document ;
        ?>
        <a href="<?php echo e(url( 'storage/documents/' . $purchase->document )); ?>" 
        download="<?php echo e($document_name); ?>" class="btn btn-sm btn-success pull-right no-print">
    ...
    <div class="col-sm-4 invoice-col">
      <b><?php echo app('translator')->getFromJson('purchase.ref_no'); ?>:</b> #<?php echo e($purchase->ref_no); ?><br/>
      ...
      <b><?php echo app('translator')->getFromJson('purchase.purchase_status'); ?>:</b> <?php echo e(ucfirst( $purchase->status )); ?><br>
      <b><?php echo app('translator')->getFromJson('purchase.payment_status'); ?>:</b> <?php echo e(ucfirst( $purchase->payment_status )); ?><br>
    </div>
  </div>
        ...
        <table class="table bg-gray">
          <thead>
            <tr class="bg-green">
              ...
              <th class="no-print"><?php echo app('translator')->getFromJson('purchase.unit_cost_before_tax'); ?></th>
              <th class="no-print"><?php echo app('translator')->getFromJson('purchase.subtotal_before_tax'); ?></th>
              <th><?php echo app('translator')->getFromJson('sale.tax'); ?></th>
              <th><?php echo app('translator')->getFromJson('purchase.unit_cost_after_tax'); ?></th>
          ...
          <?php $__empty_1 = true; $__currentLoopData = $purchase->payment_lines; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $payment_line): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            ...
            <tr>
              ...
              <td><?php if($payment_line->note): ?> 
                ...
                <?php else: ?>
                <?php echo e($payment_line->nama_rekening); ?>
