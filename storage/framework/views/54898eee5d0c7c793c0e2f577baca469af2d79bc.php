...
<style type="text/css">
    ...
    .banner-sec{background:url(./../public/images/toko2.jpeg)  no-repeat left bottom; background-size:cover; min-height:500px; border-radius: 0 10px 10px 0; padding:0;}
    ...
    <div class="row">
         ...
         <?php echo e(csrf_field()); ?>
            ...
            <div class="col-md-4 login-sec">
                <h2 class="text-center"><img style="width: 45%;" src="<?php echo e(asset('images/logo.jpeg')); ?>"></h2>
                ...
                <div class="copy-text">Asta POS <i class="fa fa-heart"></i> by Asta Brata Technology</div>
            </div>
        </form>
    ...
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                <div class="panel-heading"><?php echo app('translator')->getFromJson('lang_v1.login'); ?></div>
                <div class="panel-body">
                    <form class="form-horizontal" method="POST" action="<?php echo e(route('login')); ?>">
                        ...
                        <div class="form-group<?php echo e($errors->has('username') ? ' has-error' : ''); ?>">
                            <label for="username" class="col-md-4 control-label"><?php echo app('translator')->getFromJson('lang_v1.username'); ?></label>
                        ...
                        <div class="form-group<?php echo e($errors->has('password') ? ' has-error' : ''); ?>">
                            <label for="password" class="col-md-4 control-label"><?php echo app('translator')->getFromJson('lang_v1.password'); ?></label>
                        ...
                        <div class="form-group">
                            <div class="col-md-6 col-md-offset-4">
                                <div class="checkbox">
                                    <label>
                                        <input type="checkbox" name="remember" <?php echo e(old('remember') ? 'checked' : ''); ?>> <?php echo app('translator')->getFromJson('lang_v1.remember_me'); ?>
                                    </label>
                                </div>
                            </div>
                        </div>
