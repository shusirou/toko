	...
	<div class="box box-solid">
		<div class="box-body">
				            ...
				            <tr>
				              	...
				              	<td>
						            ...
						            data-msg-abs_digit="<?php echo app('translator')->getFromJson('lang_v1.decimal_value_not_allowed'); ?>"
			              			...
			              			data-msg-max-value="<?php echo app('translator')->getFromJson('validation.custom-messages.quantity_not_available', ['qty' => $sell_line->formatted_qty, 'unit' => $sell_line->product->unit->short_name ]); ?>" 
						            >
			...
			<div class="row">
				...
				<div class="col-sm-12 text-right">
					<strong><?php echo app('translator')->getFromJson('lang_v1.total_return_tax'); ?> - <?php if(!empty($sell->tax)): ?>(<?php echo e($sell->tax->name); ?> - <?php echo e($sell->tax->amount); ?>%)<?php endif; ?> : </strong> 
