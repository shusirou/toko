...
<div class="box">
    ...
    <?php echo Form::open(['url' => action('ManageUserController@store'), 'method' => 'post', 'id' => 'user_add_form' ]); ?>
      ...
      <div class="col-md-6">
        <div class="form-group">
          <label>Inisial:*</label> 
          <?php echo Form::text('initial', null, ['class' => 'form-control', 'required', 'placeholder' =>'Inisial' ,'id'=>'initial']);; ?>
        ...
        <div class="form-group">
          ...
          <?php if(!empty($username_ext)): ?>
            <div class="input-group">
              <?php echo Form::text('username', null, ['class' => 'form-control', 'required', 'placeholder' => __( 'business.username' ) ]);; ?>
      ...
      <div class="col-md-6">
        <div class="form-group">
          <?php echo Form::label('password', __( 'business.password' ) . ':*'); ?>
            ...
            <?php echo Form::text('password', null, ['class' => 'form-control', 'required', 'placeholder' => __( 'business.password' ) ]);; ?>
      ...
      <div class="col-md-6">
        <div class="form-group">
          <?php echo Form::label('confirm_password', __( 'business.confirm_password' ) . ':*'); ?>
            ...
            <?php echo Form::text('confirm_password', null, ['class' => 'form-control', 'required', 'placeholder' => __( 'business.confirm_password' ) ]);; ?>
  ...
  $('form#user_add_form').validate({
                rules: {
                    ...
                    initial: {
                        required: true,
                        remote: {
                            url: "/business/register/check-initial",
                            type: "post",
                            data: {
                                initial: function() {
                                    return $( "#initial" ).val();
                ...
                messages: {
                    ...
                    initial: {
                        remote: 'Invalid initial or User already exist'
                    }
                }
            });
