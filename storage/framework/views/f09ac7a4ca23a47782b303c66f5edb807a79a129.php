        ...
        <div class="box">
            <div class="box-header">
                <h3 class="box-title">
                    ...
                    <?php echo app('translator')->getFromJson( 'contact.all_purchases_linked_to_this_contact'); ?>
                </h3>
            </div>
            <div class="box-body">
                <div class="row">
    ...
    <?php if( in_array($contact->type, ['customer', 'both']) ): ?>
        <div class="box">
            <div class="box-header">
                <h3 class="box-title">
                    <i class="fa fa-money margin-r-5"></i>
                    <?php echo app('translator')->getFromJson( 'contact.all_sells_linked_to_this_contact'); ?>
                </h3>
            </div>
            <div class="box-body">
                <div class="row">
