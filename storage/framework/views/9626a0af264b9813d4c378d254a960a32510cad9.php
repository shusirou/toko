...
<div class="modal-dialog" role="document">
  <div class="modal-content">
    ...
    <div class="modal-header">
      ...
      <h4 class="modal-title"><?php echo app('translator')->getFromJson( 'lang_v1.send_notification' ); ?> - <?php echo e($template_name); ?></h4>
    </div>

    <div class="modal-body">
      <div class="form-group">
        <label class="radio-inline">
          <?php echo Form::radio('notification_type', 'email_only', true, ['class' => 'input-icheck']);; ?> <?php echo app('translator')->getFromJson('lang_v1.send_email_only'); ?>
        </label>
        <label class="radio-inline">
          <?php echo Form::radio('notification_type', 'sms_only', false, ['class' => 'input-icheck']);; ?> <?php echo app('translator')->getFromJson('lang_v1.send_sms_only'); ?>
        </label>
        <label class="radio-inline">
          <?php echo Form::radio('notification_type', 'both', false, ['class' => 'input-icheck']);; ?> <?php echo app('translator')->getFromJson('lang_v1.send_both_email_n_sms'); ?>
        </label>
      </div>
      <div id="email_div">
        <div class="form-group">
      ...
      <strong><?php echo app('translator')->getFromJson('lang_v1.available_tags'); ?>:</strong> <p class="help-block"><?php echo e(implode(', ', $tags)); ?></p>
...
// Fix for not updating textarea value on modal
  ...
  $('#send_notification_form').submit(function(e){
    ...
    $('#send_notification_btn').text("<?php echo app('translator')->getFromJson('lang_v1.sending'); ?>...");
