...
<section class="content">
	...
	<div class="box">
        <div class="box-header">
        	<h3 class="box-title"><?php echo app('translator')->getFromJson( 'contact.all_your_contact', ['contacts' => __('lang_v1.'.$type.'s') ]); ?></h3>
            	...
            	<table class="table table-bordered table-striped" id="contact_table">
                    ...
                    <tfoot>
                        <tr class="bg-gray font-17 text-center footer-total">
                            <td <?php if($type == 'supplier'): ?> colspan="4" <?php elseif( $type == 'customer'): ?> colspan="5" <?php endif; ?>><strong><?php echo app('translator')->getFromJson('sale.total'); ?>:</strong></td>
