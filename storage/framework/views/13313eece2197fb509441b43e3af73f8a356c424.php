    ...
    <div class="modal-header">
      ...
      <h4 class="modal-title no-print">
        ...
        <?php if(!empty($single_payment_line->payment_ref_no)): ?>
          ( <?php echo app('translator')->getFromJson('purchase.ref_no'); ?>: <?php echo e($single_payment_line->payment_ref_no); ?> )
        <?php endif; ?>
      </h4>
      ...
      <div class="row">
          ...
          <div class="col-xs-6">
            <b><?php echo app('translator')->getFromJson('purchase.ref_no'); ?>:</b> 
              ...
              <?php endif; ?>
              <br/>
            <b><?php echo app('translator')->getFromJson('lang_v1.paid_on'); ?>:</b> <?php echo e(\Carbon::createFromTimestamp(strtotime($single_payment_line->paid_on))->format(session('business.date_format'))); ?><br/>
          </div>
      </div>
    </div>
