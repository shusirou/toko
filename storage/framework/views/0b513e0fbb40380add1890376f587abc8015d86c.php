          ...
          <div class="nav-tabs-custom">
            ...
            <div class="tab-content">
              ...
              <div class="tab-pane" id="tab_2">
                <div class="row">
                    <div class="col-md-12">
                        <h4><?php echo app('translator')->getFromJson( 'invoice.all_your_invoice_layouts' ); ?> <a class="btn btn-primary pull-right" href="<?php echo e(action('InvoiceLayoutController@create')); ?>">
