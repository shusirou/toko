...
<body>
	...
	<table width="96%" border="1" style="border-collapse: collapse;" align="center" cellpadding="3" cellspacing="0" class="style9">
		...
		<tr>
			<td style="vertical-align: top;" class="left top bottom" width="50%">
				<table width="100%" cellpadding="0" cellspacing="0" class="style9">	
					<tbody>
						<?php $ttl_aktiva = 0; ?>
						<?php $__currentLoopData = $rekening_aktiva; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $r): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
						<tr>
							<td><strong><?php echo e($r->nama_rr); ?></strong><br> 
								<?php $__currentLoopData = $r->getRekening($r->idrekening); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ch): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
								<?php 	$jenis_buku   = new JenisBuku;
								 ...
								 <table width="100%" class="style9">
									<tbody>
										<tr>
											<td width="70%"><?php echo e($ch->kd_jb); ?>.<?php echo e($ch->nama_jb); ?></td>
											<td width="30%" class="align-right">
											<?php echo e(number_format($faktiva)); ?>	
											</td>
										</tr>
									</tbody>
								</table>
		   ...
		   <td class="all" valign="top" width="50%">
				<table width="100%" cellpadding="0" cellspacing="0" class="style9">
					<tbody>
						<?php $ttl_passiva = 0; ?>
						<?php $__currentLoopData = $rekening_pasiva; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $r): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
						<tr>
							<td><strong><?php echo e($r->nama_rr); ?></strong><br> 
								<?php $__currentLoopData = $r->getRekening($r->idrekening); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ch): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
								<?php 	$jenis_buku   = new JenisBuku;
								 ...
								 <table width="100%" class="style9">
									<tbody>
										<tr>
											<td width="70%"><?php echo e($ch->kd_jb); ?>.<?php echo e($ch->nama_jb); ?></td>
											<td width="30%" class="align-right">
											<?php echo e(number_format($fpassiva)); ?>		
											</td>
										</tr>
									</tbody>
								</table>
						...
						<tr>
							...
							<td><?php echo e(number_format($laba_rugi)); ?></td>
						</tr> 
					</tbody>
				</table>
		  </td>
	    ...
	    <tr>
		  <th height="30" class="left top bottom" style="text-align: right;"><span class="pull-right"><?php echo e(number_format($ttl_aktiva)); ?></span></th>
		  <th class="all" style="text-align: right;"><span class="pull-right" ><?php echo e(number_format($ttl_passiva + $laba_rugi)); ?></span></th>
	    </tr>
		<tr>
