<div class="modal-dialog" role="document">
  <div class="modal-content">
    ...
    <?php echo Form::open(['url' => action('TransactionPaymentController@update', [$payment_line->id]), 'method' => 'put', 'id' => 'transaction_payment_add_form' ]); ?>
    ...
    <div class="modal-body">
      <div class="row">
        ...
        <div class="col-md-4">
          <div class="well">
            <strong><?php echo app('translator')->getFromJson('purchase.supplier'); ?>: </strong><?php echo e($transaction->contact->name); ?><br>
        ...
        <div class="col-md-4">
          <div class="well">
            <strong><?php echo app('translator')->getFromJson('purchase.ref_no'); ?>: </strong><?php echo e($transaction->ref_no); ?><br>
        ...
        <div class="col-md-4">
          <div class="well">
            <strong><?php echo app('translator')->getFromJson('purchase.purchase_total'); ?>: </strong><span class="display_currency" data-currency_symbol="true"><?php echo e($transaction->final_total); ?></span><br>
