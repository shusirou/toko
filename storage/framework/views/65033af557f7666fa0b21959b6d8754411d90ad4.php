...
<div class="box">
    ...
    <?php echo Form::open(['url' => action('ManageUserController@update', [$user->id]), 'method' => 'PUT', 'id' => 'user_edit_form' ]); ?>
      ...
      <div class="col-md-6">
        <div class="form-group">
          <label>Inisial:*</label> 
          <?php echo Form::text('initial', $user->initial, ['class' => 'form-control', 'required', 'placeholder' =>'Inisial' ,'id'=>'initial']);; ?>
      ...
      <div class="col-md-6">
        <div class="form-group">
          <?php echo Form::label('password', __( 'business.password' ) . ':'); ?>
            ...
            <?php echo Form::text('password', null, ['class' => 'form-control', 'placeholder' => __( 'business.password' ) ]);; ?>
      ...
      <div class="col-md-6">
        <div class="form-group">
          <?php echo Form::label('confirm_password', __( 'business.confirm_password' ) . ':'); ?>
            ...
            <?php echo Form::text('confirm_password', null, ['class' => 'form-control', 'placeholder' => __( 'business.confirm_password' ) ]);; ?>
