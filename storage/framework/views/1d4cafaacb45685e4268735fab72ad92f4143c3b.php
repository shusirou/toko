            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-header">
                <?php if(!empty(Session::get('business.logo'))): ?>
                  <img src="<?php echo e(url( 'storage/business_logos/' . Session::get('business.logo') )); ?>" alt="Logo"></span>
                <?php endif; ?>
                <p>
              ...
              <li class="user-footer">
                <div class="pull-left">
                  <a href="<?php echo e(action('UserController@getProfile')); ?>" class="btn btn-default btn-flat"><?php echo app('translator')->getFromJson('lang_v1.profile'); ?></a>
                </div>
                <div class="pull-right">
                  <a href="<?php echo e(action('Auth\LoginController@logout')); ?>" class="btn btn-default btn-flat"><?php echo app('translator')->getFromJson('lang_v1.sign_out'); ?></a>
                </div>
              </li>
            </ul>
          </li>
