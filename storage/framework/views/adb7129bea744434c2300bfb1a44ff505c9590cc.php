						...
						<table class="table table-condensed table-bordered table-th-green text-center table-striped" id="purchase_entry_table">
							<thead>
								<tr>
									...
									<th class="<?php echo e($hide_tax); ?>"><?php echo app('translator')->getFromJson( 'purchase.subtotal_before_tax' ); ?></th>
									<th class="<?php echo e($hide_tax); ?>"><?php echo app('translator')->getFromJson( 'purchase.product_tax' ); ?></th>
									<th class="<?php echo e($hide_tax); ?>"><?php echo app('translator')->getFromJson( 'purchase.net_cost' ); ?></th>
