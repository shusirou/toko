...
<section class="content">
        ...
        <div class="col-md-12">
            ...
            <div class="box box-solid">
                <div class="box-header">
                    <h3 class="box-title"><?php echo app('translator')->getFromJson('lang_v1.customer_notifications'); ?>:</h3>
                </div>
                <div class="box-body">
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="box box-solid">
                <div class="box-header">
                    <h3 class="box-title"><?php echo app('translator')->getFromJson('lang_v1.supplier_notifications'); ?>:</h3>
                </div>
                <div class="box-body">
