...
<section class="content">
	...
	<div class="box box-solid">
		<div class="box-header">
			<h3 class="box-title"><?php echo app('translator')->getFromJson('lang_v1.parent_purchase'); ?></h3>
		</div>
		<div class="box-body">
			<div class="row">
				<div class="col-sm-4">
					<strong><?php echo app('translator')->getFromJson('purchase.ref_no'); ?>:</strong> <?php echo e($purchase->ref_no); ?> <br>
					<strong><?php echo app('translator')->getFromJson('messages.date'); ?>:</strong> <?php echo e(\Carbon::createFromTimestamp(strtotime($purchase->transaction_date))->format(session('business.date_format'))); ?>

				</div>
				<div class="col-sm-4">
					<strong><?php echo app('translator')->getFromJson('purchase.supplier'); ?>:</strong> <?php echo e($purchase->contact->name); ?> <br>
					<strong><?php echo app('translator')->getFromJson('purchase.business_location'); ?>:</strong> <?php echo e($purchase->location->name); ?>
				            ...
				            <tr>
				              	...
				              	<td>
						            ...
						            <?php if($purchase_line->product->enable_stock): ?> 
				              			...
				              			data-msg-max-value="<?php echo app('translator')->getFromJson('validation.custom-messages.quantity_not_available', ['qty' => $purchase_line->formatted_qty_available, 'unit' => $purchase_line->product->unit->short_name ]); ?>" 
				              		<?php endif; ?>
						            >
