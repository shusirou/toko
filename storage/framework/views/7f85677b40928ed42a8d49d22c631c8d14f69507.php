		 ...
		 <?php if($tax_rate['is_tax_group']): ?>
		 	<tr>
		 		<td class="text-muted" style="padding-top: 0;">
		 			<?php $__currentLoopData = $tax_rate['group_tax_details']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
		 				<small><?php echo e($key); ?></small> - <small><span class="display_currency" data-currency_symbol="true"><?php echo e($value); ?></span></small><br>
