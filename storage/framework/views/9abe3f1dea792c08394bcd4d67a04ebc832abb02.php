        	...
        	<table class="table table-bordered table-striped" id="supplier_report_tbl">
        		<thead>
        			<tr>
                        ...
                        <th><?php echo app('translator')->getFromJson('report.total_due'); ?> &nbsp;&nbsp;<i class="fa fa-info-circle text-info" data-toggle="tooltip" data-placement="bottom" data-html="true" data-original-title="<?php echo e(__('messages.due_tooltip')); ?>" aria-hidden="true"></i></th>
        			</tr>
        		</thead>
        	</table>
            </div>
