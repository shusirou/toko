...
<div class="col-sm-12">
    ...
    <table class="table table-bordered add-product-price-table table-condensed" id="product_variation_form_part">
        <thead>
          <tr>
            <th class="col-sm-3"><?php echo app('translator')->getFromJson('lang_v1.variation'); ?></th>
            <th class="col-sm-9"><?php echo app('translator')->getFromJson('product.variation_values'); ?></th>
          </tr>
        </thead>
        <tbody>
            <?php if($action == 'add'): ?>
