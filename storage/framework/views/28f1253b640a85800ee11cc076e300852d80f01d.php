...
<input type="hidden" id="item_addition_method" value="<?php echo e($business_details->item_addition_method); ?>">
							...
							<div class="col-sm-4" style="display: none;">
								<div class="form-group">
									<div class="input-group">
										...
										<?php echo Form::text('hidden_price_group', key($price_groups), ['id' => 'hidden_price_group']); ?>
					...
					<div class="<?php if(!empty($commission_agent)): ?> col-sm-3 <?php else: ?> col-sm-4 <?php endif; ?>">
						<div class="form-group">
							...
							<div class="input-group">
								...
								<input type="hidden" id="default_price_group" name="default_price_group"
								value="<?php echo e($walk_in_customer['selling_price_group_id']); ?>" >
				...
				<div class="box-body">
					...
					<div class="row col-sm-12 pos_product_div" style="min-height: 0">
						...
						<table class="table table-condensed table-bordered table-striped">
							<tr>
								<td>
									<div class="pull-right"><b><?php echo app('translator')->getFromJson('sale.total'); ?>: </b>
	...
	<div class="box box-solid" id="payment_rows_div"><!--box start-->
		<div class="box-header">
			<h3 class="box-title">
				<?php echo app('translator')->getFromJson('purchase.add_payment'); ?>
			</h3>
		</div>
		<div class="box-body payment_row">
			<?php echo $__env->make('sale_pos.partials.payment_row_form_old', ['row_index' => 0], array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
			<hr>
			<div class="row">
				<div class="col-sm-12">
...
<?php $__env->startSection('javascript'); ?>
	<script src="<?php echo e(asset('js/mask.js?v=' . $asset_v)); ?>"></script>
