               ...
               <div class="col-md-4">
                   <div class="form-group">
                       ...
                       <select class="form-control select2" name="bulanan" id="bulanan">
                           ...
                           <?php $__currentLoopData = $bulan; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ky=>$vl): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                           <option value="<?php echo e($ky); ?>" <?php if($ky == date('m')): ?> selected="" <?php endif ?> ><?php echo e($vl); ?></option>
                   ...
                   <div class="form-group bukubesardiv">
                     ...
                     <select class="form-control select2" name="jenis_buku_besar" id="jenis_buku_besar">
                       <?php $__currentLoopData = $jenisbuku; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $jb): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e(strtolower($jb->ins)); ?>"><?php echo e($jb->nama_jb); ?></option>
                       <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                     </select>
                   </div>
               </div>
...
<script type="text/javascript">
  ...
  function cetak(type){
    ...
    {
      var urlx = "<?php echo e(url('reports')); ?>/"+namalaporan;
      ...
      if(namalaporan == 'buku_besar'){
        urlx        = "<?php echo e(url('laporan')); ?>/"+namalaporan+'?jenis_buku_besar='+jenisbukubesar+'&type='+type+'&tgl='+tgl+'&bln='+bln+'&thn='+thn;
      }else{
        urlx        = "<?php echo e(url('laporan')); ?>/"+namalaporan+'?type='+type+'&tgl='+tgl+'&bln='+bln+'&thn='+thn;
      }
