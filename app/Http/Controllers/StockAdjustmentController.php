            ...
            if (!empty($products)) {
                ...
                foreach ($products as $product) {
                    ...
                    $adjustment_line = [
                        ...
                        'kurang_tambah' => $request->input('kurang_tambah'),
                        'id_rekening_debit' => $request->input('kurang_tambah') == 'kurang' ? '513.01' : '111.09',
                        'id_rekening_kredit'=> $request->input('kurang_tambah') == 'kurang' ? '111.27' : '411.04',
                    ];
