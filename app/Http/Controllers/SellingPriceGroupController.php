...
class SellingPriceGroupController extends Controller
{
    ...
    public function index()
    {
        ...
        if (request()->ajax()) {
            ...
            $price_groups = SellingPriceGroup::where('selling_price_groups.business_id', $business_id)
                        ->select(['selling_price_groups.name', 'selling_price_groups.description','selling_price_groups.id']);
