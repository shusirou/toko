...
class ManageUserController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        try {
            $user_details = $request->only(['surname', 'first_name', 'last_name', 'username', 'email','initial', 'password', 'selected_contacts']);
            ...
            $user_details['initial']  = $request->input('initial'); 
    ...
    public function update(Request $request, $id)
    {
        ...
        try {
            $user_data = $request->only(['surname', 'first_name', 'last_name', 'initial','email', 'selected_contacts']);
            ...
            $user_data['initial']  = $request->input('initial'); 
