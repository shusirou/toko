...
class RekeningRiil extends Model
{
    ...
    public function getPendapatanBiayaAwal()
    {
        ...
        $get_pendapatan_kredit = Rekening::selectRaw('COALESCE(SUM(CAST(awal as INT)),0)as ttl')
                                         ->where('business_id',auth()->user()->business_id)
        ...
        $get_pendapatan_debit = Rekening::selectRaw('COALESCE(SUM(CAST(awal as INT)),0)as ttl')
                                         ->where('business_id',auth()->user()->business_id)
        ...
        $get_biaya_kredit = Rekening::selectRaw('COALESCE(SUM(CAST(awal as INT)),0)as ttl')
                                         ->where('business_id',auth()->user()->business_id)
                                         ->where('jenis_mutasi','kredit')
        ...
        $get_biaya_debit = Rekening::selectRaw('COALESCE(SUM(CAST(awal as INT)),0)as ttl')
                                         ->where('business_id',auth()->user()->business_id)
                                         ->where('jenis_mutasi','debit')
                                         ->whereRaw('LEFT(kd_rekening,2) = 51');
    ...
    public function getLabaRugi($tgl=null,$bln=null,$thn=null)
    {
    ...
    private function fromTransaction($kode,$idjenisbuku,$tgl=null,$bln=null,$thn=null,$period=null)
    {
        $m_now            = $bln != null ? $bln : date('m');
        $y_now            = $thn != null ? $thn : date('Y');
        $awal_tahun       = $thn != null ? Carbon::create($thn, 1, 31, 12, 0, 0)->startOfYear() : Carbon::now()->startOfYear();
    ...
    private function fromShippingCharges($kode,$idjenisbuku,$tgl=null,$bln=null,$thn=null,$period=null)
    {
        $m_now            = $bln != null ? $bln : date('m');
        $y_now            = $thn != null ? $thn : date('Y');
        $awal_tahun       = $thn != null ? Carbon::create($thn, 1, 31, 12, 0, 0)->startOfYear() : Carbon::now()->startOfYear();
    ...
    private function fromTransactionPayment($kode,$idjenisbuku,$tgl=null,$bln=null,$thn=null,$period=null)
    {
        $m_now            = $bln != null ? $bln : date('m');
        $y_now            = $thn != null ? $thn : date('Y');
        $awal_tahun       = $thn != null ? Carbon::create($thn, 1, 31, 12, 0, 0)->startOfYear() : Carbon::now()->startOfYear();
    ...
    private function fromJurnal($kode,$idjenisbuku,$tgl=null,$bln=null,$thn=null,$period=null)
    {
        $m_now            = $bln != null ? $bln : date('m');
        $y_now            = $thn != null ? $thn : date('Y');
        $awal_tahun       = $thn != null ? Carbon::create($thn, 1, 31, 12, 0, 0)->startOfYear() : Carbon::now()->startOfYear();
    ...
    public function fromStockAdjustment($kode,$idjenisbuku,$tgl=null,$bln=null,$thn=null,$period=null)
    {
        $m_now            = $bln != null ? $bln : date('m');
        $y_now            = $thn != null ? $thn : date('Y');
        $awal_tahun       = $thn != null ? Carbon::create($thn, 1, 31, 12, 0, 0)->startOfYear() : Carbon::now()->startOfYear();
