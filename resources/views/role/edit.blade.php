      ...
      <div class="row check_group">
        ...
        <div class="col-md-9">
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                {!! Form::checkbox('permissions[]', 'jurnal.view', in_array('jurnal.view', $role_permissions), 
                [ 'class' => 'input-icheck']); !!} {{ __( 'role.jurnal.view' ) }}
              </label>
            </div>
          </div>
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                {!! Form::checkbox('permissions[]', 'jurnal.create', in_array('jurnal.create', $role_permissions), 
                [ 'class' => 'input-icheck']); !!} {{ __( 'role.jurnal.create' ) }}
              </label>
            </div>
          </div>
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                {!! Form::checkbox('permissions[]', 'jurnal.update', in_array('jurnal.update', $role_permissions), 
                [ 'class' => 'input-icheck']); !!} {{ __( 'role.jurnal.update' ) }}
              </label>
            </div>
          </div>
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                {!! Form::checkbox('permissions[]', 'jurnal.delete', in_array('jurnal.delete', $role_permissions), 
                [ 'class' => 'input-icheck']); !!} {{ __( 'role.jurnal.delete' ) }}
              </label>
            </div>
          </div>
        </div>
