<div class="row">
	...
	<div class="{{$col_class}}">
		<div class="form-group">
			...
			<div class="input-group">
				{!! Form::text("payment[$row_index][amount]", @num_format($payment_line['amount']), ['class' => 'form-control payment-amount input_number', 'required','readonly', 'id' => "amount_$row_index",'style'=>'font-size:32px;text-align:center;border:0px;', 'placeholder' => __('sale.amount')]); !!}
			</div>
		</div>
	</div>
	<div class="{{$col_class}}">
	...
	<div class="{{$col_class}}">
		<div class="form-group">
			<label>Bayar</label>
			<input type="text" name="bayar" placehoder="Bayar" value="" style="font-size: 32px; text-align: right;" id="bayar" class="duit form-control payment-amount input_number">
		</div>
	</div>
	<div class="{{$col_class}}">
		<div class="form-group">
			<label>Kembali</label>
			<input type="text" name="kembali" readonly="" id="kembali" style="font-size: 32px; text-align: right;" class="form-control payment-amount input_number">
		</div>
	</div>
	<div class="clearfix"></div>
