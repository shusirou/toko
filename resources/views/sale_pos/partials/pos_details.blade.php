					...
					<tr>
						...
						<div class="">
							...
							<div class="col-sm-10 col-no-padding">
								...
								<div class="col-sm-4 col-2px-padding">
									<button type="button" disabled="" class="btn btn-success btn-block btn-flat btn-lg no-print @if($pos_settings['disable_express_checkout'] != 0) hide @endif pos-express-btn pos-express-finalize"
