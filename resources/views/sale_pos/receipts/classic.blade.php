<div class="row">
	<div class="col-xs-12 text-center">
		<table class="" cellpadding="0" style="margin-left:5px; margin-right:5px; margin-bottom:5px;font-size:9px; width: 95%;">
			<tr>
				<td colspan="3" style="text-align: center;">@if(!empty($receipt_details->display_name)){{strtoupper($receipt_details->display_name)}}@endif
				</td>
			</tr>
			<tr >
		...
		<table class="" cellpadding="0" style="margin:5px;width:85%;font-size:9px; ">
			@forelse($receipt_details->lines as $line)
				...
				<tr>
					...
					<td>Diskon</td>
					<td>:</td>
					<td>{{number_format(round($receipt_details->discount))}}</td>
				</tr>
				@endif
